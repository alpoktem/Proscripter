...
def readTedDataToMemory(file_wordalign, file_wordaggs_f0, file_wordaggs_i0):
...
def structureData(word_id_to_f0_features_dic, word_id_to_i0_features_dic, word_data_aligned_dic):
	structured_data = []
